...
contract EventTicketing is ERC721, Ownable {
    ...
    struct Event {
        ...
        string imageCID; // new variable to store the image CID
    ...
    function createEvent(
        ...
        string memory _imageCID // add the image CID as a parameter
        ...
        events[eventId] = Event({
            ...
            imageCID: _imageCID // assign the image CID to the new variable
